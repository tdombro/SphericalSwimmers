...
public:
    ...
    const std::vector<double> & getCurrentDiscPosition();

    /*
    */
    inline const std::vector<double> & getCurrentIncrementedAngleFromReferenceAxis()
    {
        return d_incremented_angle_from_reference_axis;
    }

    /*
    */
    inline const std::vector<double> & getCurrentStructureCOM()
    {
    ...
    /*
    */
    inline const double getCurrenTime()
    {
...
private:
    ...
    double d_frequency;
    double d_ds;
    double d_accepted_radius_0, d_accepted_radius_1;
    double d_current_length;
    int d_n_pts_0, d_n_pts_1;
