...
def PlotCombinedStream(cwd,time,mx,my,w,Ux,Uy,pos,pars):
    ...
    if(field == 'W_stream'):
        ...
        ax.streamplot(x,y,Ux.T,Uy.T,color='k',linewidth=1.5,arrowsize=1.0,density=2.0)
    else:
        magU = np.hypot(Ux,Uy)
        ...
        ax.streamplot(x,y,Ux.T,Uy.T,color='w',linewidth=1.5,arrowsize=1.0,density=2.0)
