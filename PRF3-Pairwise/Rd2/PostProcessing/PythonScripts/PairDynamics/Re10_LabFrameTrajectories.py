...
if __name__ == '__main__':
    ...
    for idx in range(len(parHxList)):
        ...
        if Theta == ThetaValue:
            ...
            strMovie = cwd_PYTHON+"/../Figures/LabTrajectories/Re10/T{0}/TrajMov_T{1}_Hx{2}_Hy{3}_.mp4".format(Theta,Theta,Hx,Hy)
            ...
            if boolMovie == False:
                for idxTime in range(len(HyData['time'])):
                    ...
                    #plt.show()
                    #sys.exit(0)
                    strDir = cwd_PYTHON+"/../Figures/LabTrajectories/Re10/T{0}/".format(Theta)
                    ...
                    if idxTime % 20 == 0:
                        print('time = ',time)
                os.chdir(cwd_PYTHON+"/../Figures/LabTrajectories/Re10/T{0}/".format(Theta))
