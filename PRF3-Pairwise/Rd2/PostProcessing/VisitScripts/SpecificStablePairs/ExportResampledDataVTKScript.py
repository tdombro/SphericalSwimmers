...
Re = sys.argv[1]
Config = sys.argv[2]
timeVTK = float(sys.argv[3])

Nbots=2

collectivePath=dir_path+"../"+Config+"/Re"+Re+"/"
...
idxStart = int(100*timeVTK)
idxEnd = idxStart + 21

#for state in range(TimeSliderGetNStates()):
for state in range(idxStart,idxEnd):
    # Change time states
    ...
    dbAtts.variables = ("default", "amr_mesh","levels", "patches","U","Omega","P")
