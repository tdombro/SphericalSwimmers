...
def GetAxisBounds(pos):
    ...
    maxCenterX = max(pos.loc[0,'aXU_rot'],pos.loc[0,'aXL_rot'],pos.loc[0,'bXU_rot'],pos.loc[0,'bXL_rot'])
    minCenterX = min(pos.loc[0,'aXU_rot'],pos.loc[0,'aXL_rot'],pos.loc[0,'bXU_rot'],pos.loc[0,'bXL_rot'])
    maxCenterY = max(pos.loc[0,'aYU_rot'],pos.loc[0,'aYL_rot'],pos.loc[0,'bYU_rot'],pos.loc[0,'bYL_rot'])
    minCenterY = min(pos.loc[0,'aYU_rot'],pos.loc[0,'aYL_rot'],pos.loc[0,'bYU_rot'],pos.loc[0,'bYL_rot'])
...
def PlotCombinedStream(cwd,time,mx,my,w,Ux,Uy,pos,pars):
    ...
    interpUx, interpUy = InterpolateToNewCoordinateSystem(mx_rot,my_rot,Ux_rot,Uy_rot)
