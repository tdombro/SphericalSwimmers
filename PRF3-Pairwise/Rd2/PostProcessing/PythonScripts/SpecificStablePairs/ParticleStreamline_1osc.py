...
cwd_FIGS = cwd_PYTHON+'../Figures/ParticleStreamline/{0}/Re{1}/per{2}/'.format(config,Re,perNumber)#cwd_PYTHON+"../../Figures/ParticleStreamline/TestField2/"
pathlib.Path(cwd_FIGS).mkdir(parents=True, exist_ok=True)
cwd_Re = cwd_PYTHON+'../{0}/Re{1}/VTK/AVG/'.format(config,Re)#cwd_PYTHON+'../../FieldData/TestField/'
cwd_POS = cwd_POS = cwd_PYTHON+'../PosData/{0}/Re{1}/'.format(config,Re)#cwd_POS = cwd_PYTHON+'../../FieldData/TestField/'
