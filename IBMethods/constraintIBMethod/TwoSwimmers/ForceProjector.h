...
public:
    ...
    void updateStructCoordinates(const std::vector<std::vector<double>> &);
...
private:
     ...
     */
    double d_vol_lag_pt;
    int d_n_large , d_n_small;
    double d_radius_0, d_radius_1, d_delta, d_kappa;
    std::vector<std::vector<double>> d_struct_pos_vec ;
    std::vector<std::vector<double>> d_repul_force ;
    double d_wall_left_x, d_wall_right_x, d_wall_up_y, d_wall_bottom_y;
    bool d_enable_wall, d_enable_circle_bdry;
    double d_circle_bdry_radius;
    std::vector<double> d_circle_center;
