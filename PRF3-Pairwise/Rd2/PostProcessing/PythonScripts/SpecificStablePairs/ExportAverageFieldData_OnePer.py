...
if __name__ == '__main__':
    ...
    cwd_Re = cwd_PYTHON+'../{0}/Re{1}/'.format(config,Re)
    #Calculate # Periods
    DUMP_INT = 20.0
    DT, PERIOD = 0.005, 0.1
    ...
    for countPer in range(nPer):
        ...
        avgFieldData.to_csv(cwd_DATA+'AVG/AVG_%04d.csv'%perNumber,index=False,sep=' ',float_format='%.5e')
